...
@section('title', 'Bina Düzenle')

@section('content')
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2">Bina Düzenle</h1>
...
<div class="row">
    <div class="col-md-6">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.binalar.update', $bina) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('bina_adi') is-invalid @enderror" 
                               id="bina_adi" name="bina_adi" value="{{ old('bina_adi', $bina->bina_adi) }}" required>
                        @error('bina_adi')
                    ...
                    <div class="mb-3 form-check">
                        <input type="checkbox" class="form-check-input" id="aktif_mi" name="aktif_mi" 
                               value="1" {{ old('aktif_mi', $bina->aktif_mi) ? 'checked' : '' }}>

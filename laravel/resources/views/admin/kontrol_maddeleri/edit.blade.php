            ...
            <div class="card-body">
                <form action="{{ route('admin.kontrol-maddeleri.update', $kontrolMaddesi) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3" id="birim_div" style="display: {{ old('kontrol_tipi', $kontrolMaddesi->kontrol_tipi) == 'sayisal' ? 'block' : 'none' }};">
                            ...
                            <input type="text" class="form-control @error('birim') is-invalid @enderror" 
                                   id="birim" name="birim" value="{{ old('birim', $kontrolMaddesi->birim) }}" 
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-check">
                                <input type="checkbox" class="form-check-input" id="zaman_secimi" name="zaman_secimi" 
                                       value="1" {{ old('zaman_secimi', $kontrolMaddesi->zaman_secimi) ? 'checked' : '' }}>
...
// Sayfa yüklendiginde kontrol et

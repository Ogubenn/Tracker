        ...
        <form action="{{ route('admin.kontrol-kayitlari.index') }}" method="GET">
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <input type="date" name="tarih_baslangic" class="form-control" value="{{ request('tarih_baslangic') }}">
                </div>
                <div class="col-md-3">
                    <label class="form-label">Bitiş Tarihi</label>
                    <input type="date" name="tarih_bitis" class="form-control" value="{{ request('tarih_bitis') }}">
                </div>
                <div class="col-md-3">
            ...
            <div class="row g-3 mt-2">
                ...
                <div class="col-md-3">
                    <label class="form-label">&nbsp;</label>
                    <a href="{{ route('admin.kontrol-kayitlari.index') }}" class="btn btn-secondary d-block w-100">
